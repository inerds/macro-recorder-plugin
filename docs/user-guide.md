...
| **Scope caption** | Under the key: the name of what the recorder watches — the selected layer, such as *LAYER A*, or the scene's own name when nothing is selected, such as *MAIN SCENE*. It says the same thing while you record. |
