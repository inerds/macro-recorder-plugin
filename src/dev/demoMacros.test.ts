 ...
 *
 * The replay proof lives in `plugin/demoMacros.replay.test.ts`, not here: it
 * needs the playback orchestrator, and this project deliberately has no
 * `creator` global (tsconfig.app.json vs tsconfig.plugin.json). Changing a
 * macro's steps means re-running both.
 */
import { describe, expect, it } from "vitest";

import { editableValueOf } from "../../shared/editing";
